...
<?php
	...
	$countryCode = '';
	if(array_key_exists($todder->invoice_country_code, $countriesCode)){
		$countryCode = $countriesCode[$todder->invoice_country_code];
	}
?>
                                                        <tr>
                                                            <td style="color: #1D232E;
                                                                                ...
                                                                                line-height: 23px;">
                                                                Invoice No
                                                                <span style="font-weight: 400;">TOD{{$countryCode}} {{str_repeat("0", $digitRem)}}{{$payment->id}}</span>
                                                            </td>
                                                        </tr>
                                                        <!-- <tr>
                                                        ...
                                                        <tr>
                                                            <td style="color: #1D232E;
                                                                                ...
                                                                                line-height: 23px;">
                                                                VAT No
                                                                <span style="font-weight: 400;">{{$admincomission->vat_number}}</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                            ...
                                                            <td style="vertical-align: top;">
                                                                <table class="deviceWidth1" width="290"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        letter-spacing: 0;
                                                                        line-height: 23px;">
                                                                        Talent Name: {{$project->talents[0]->first_name ?? ''}}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="color: #1D232E;
                                                                        ...
                                                                        letter-spacing: 0;
                                                                        line-height: 23px;">
                                                                        Todder VAT No: {{$talentUserGstNumber}}
                                                                        </td>
                                                                    </tr>
