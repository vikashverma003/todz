      ...
      <table align="center" style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
         <tr>
            <td style="background-color: #fff;">
               <table class="deviceWidth" align="center" width="650" style="width: 650px; max-width:650px;" border="0"
                        ...
                        <table align="center" style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                              <td style="background-color: #ffffff;" bgcolor="#ffffff">
                                 <table class="deviceWidth1" style="margin: 0 auto;width: 100%;"
...
?>
                                             ...
                                             <tr>
                                                <td>
                                                   <table>
                                                      <tr>
                                                         <td colspan="3" style="color: #1D232E;
                                                            font-size: 17px;
                                                            font-weight: 600;
                                                            letter-spacing: 0;
                                                            ...
                                                            Invoice No
                                                            <span
                                                               style="font-weight: 400;">CLI{{$countryCode}} {{str_repeat("0", $digitRem)}}{{$payment->id}}</span>
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                         <td style="color: #1D232E;
                                                            ...
                                                            VAT No
                                                            <span
                                                               style="font-weight: 400;">{{$admincomission->vat_number}}</span>
                                                         </td>
                                                         <td width="20"></td>
                                                         <td style="color: #1D232E;
                                                            font-size: 17px;
                                                            ...
                                                            Date
                                                            <span
                                                               style="font-weight: 400;">{{date('d/m/Y', strtotime($payment->created_at))}}</span>
                                                         </td>
                                                      </tr>
                                                   </table>
                                                </td>
                                          ...
                                          <table style="width: 100%;" border="0" cellspacing="0"
                                             ...
                                             <tr>
                                                <td style="vertical-align: top;">
                                                   <table class="deviceWidth1" width="250"
                                                      style="width: 250px;border:1.5px solid #1D232E;"
                                                      align="center" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                         <td>
                                                            <table class="deviceWidth1" width="230"
                                                               ...
                                                               <tr>
                                                                  <td>
                                                                      <p style="text-align: left;">
                                                                        {{ \Illuminate\Support\Str::limit($project->description, 650, $end='...') }}
                                                                      </p>
<!--
                                                                     <textarea name="" id=""
                                                                        cols="30" rows="20"
                                                                        placeholder="(description as agreed with client)
                                                                        "
                                                                        style="color: #1D232E;
                                                                        font-size: 17px;
                                                                        font-weight: 400;
                                                                        letter-spacing: 0;
                                                                        line-height: 23px;
                                                                        padding: 5px 10px;background-color: #FDEF98;border: none;resize: none;width: 210px;"></textarea>
-->
                                                                  </td>
                                                               </tr>
                                                               <tr>
                                                ...
                                                <td>
                                                   <table class="deviceWidth1"
                                                      style="width: 330px;border:1.5px solid #1D232E;"
                                                      align="center" border="0" cellspacing="0"
                                                      cellpadding="0">
                                                      <tr>
                                                         <td>
                                                            <table class="deviceWidth1" width="310"
                                                               style="margin: 0 auto; width: 310px;"
                                                               align="center" border="0"
                                                               cellspacing="0" cellpadding="0">
                                                               <tr>
                                                                  <td style="font-size: 1px; line-height: 1px;"
                                                                     ...
                                                                     <table style="width: 100%;">
                                                                        <tr>
                                                                           ...
                                                                           <td
                                                                              ...
                                                                              {{$projectTalent->no_of_hours}} Hours
                                                                           </td>
                                                                        </tr>
                                                                     </table>
                                                                  </td>
                                                                     ...
                                                                     <table style="width: 100%;">
                                                                        <tr>
                                                                           ...
                                                                           <td
                                                                              ...
                                                                              letter-spacing: 0;
                                                                              line-height: 23px;text-align: right;">
                                                                              {{config('constants.APP_CURRENCY')}}{{$talent->hourly_rate}}
                                                                           </td>
                                                                        </tr>
                                                                     </table>
                                                                  </td>
...
@php
    $total_fee = ($talent->hourly_rate*$project_duration);
                                                                              ...
                                                                              <table
                                                                                 ...
                                                                                 <tr>
                                                                                    ...
                                                                                    <td
                                                                                       ...
                                                                                       {{config('constants.APP_CURRENCY')}}{{$payment_gateway_fee}}
                                                                                    </td>
                                                                                 </tr>
                                                                              </table>
                                                                           </td>
                                    ...
                                    <tr>
                                       <td>
                                          <table style="width: 100%;" border="0" cellspacing="0"
                                             ...
                                             <tr>
                                                <td>
                                                   <table class="deviceWidth1" width="220"
                                                      style="width: 220px;" align="center" cellspacing="0"
                                                      cellpadding="0">
                                                      <tr>
                                                         <td style="color: #1D232E;
                                                            font-size: 17px;
                                                ...
                                                <td>
                                                   <table class="deviceWidth1" width="310"
                                                      style="width: 310px;" align="center" cellspacing="0"
                                                      cellpadding="0">
                                                      <tr>
                                                         <td>
