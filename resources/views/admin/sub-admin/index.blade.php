      ...
      <div class="col-lg-12 stretch-card">
         ...
         <div class="card">
            <div class="card-body">
               ...
               <a class="nav-link add_button mb-3" href="{{url('admin/sub-admins/create')}}">
                    <i class=" icon-plus menu-icon"></i>
                    <span class="menu-title">Add</span>
                </a>
                <a href="{{route('export-sub-admin')}}" class="btn btn-success mb-3 float-right" target="_blank" ><i class="fa fa-export"></i>Export</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function cb(start, end) {
            ...
            loadListings(full_path + '/sub-admins/?page=');
        }
