      ...
      <div class="col-lg-12 stretch-card">
         ...
         <div class="card">
            <div class="card-body">
               ...
               <a href="{{route('export-client')}}" class="btn btn-success mb-3 float-right" target="_blank" ><i class="fa fa-export"></i>Export</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function cb(start, end) {
            ...
            loadListings(full_path + '/clients/?page=');
        }
