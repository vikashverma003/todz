...
<div class="content-wrapper">
   <div class="row">
      <div class="col-lg-12 stretch-card">
         <div class="card">
            <div class="card-body">
               <h4 class="card-title">Talents Summary</h4>
               ...
               <div class="float-right">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="datatable_ajax" aria-describedby="datatable_ajax_info" role="grid">
                            <thead>
                                ...
                                <tr role="row" class="filter print-hide">
                                    ...
                                    <td rowspan="1" colspan="1">
                                         <select name="test_status"  class="form-control" id="filterStatus">
                                            <option value="">Status</option>
                                    ...
                                    <td>
                                        <select name="job_category"  class="form-control" id="filterStatus">
                                    ...
                                    <td rowspan="1" colspan="1" class="sr_no">
                                        <button class="btn btn-sm btn-danger red filter-cancel m-1 p-2"><i class="fa fa-times"></i> Reset Filter</button>
                                    </td>
                                    
                                </tr>
                            </thead>
                            <tbody id="dynamicContent">
                                @include('admin.talent.summary.list')
                            </tbody>
                        </table>
                    </form>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">  
                                <h4 class="card-title">Talents Summary Graph</h4>             
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function cb(start, end) {
            ...
            loadListings(full_path + '/talent-summary/?page=');
    ...
    const getRevenueGraphs = (start, end)=>{
        $.ajax({
            url:"{{url('admin/talent-summary-graph')}}",
            type:'get',
            data:{
                'start':start,
                'end':end
            ...
            success:function(data){
                ...
                if(data.status)
                {
                    var label =[];
                    var value =[];
                    $.each(data.data.talentResponse, function(key,val){
