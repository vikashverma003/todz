         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="float-right">
                   <a href="{{route('export-revenues-pdf')}}" class="btn btn-primary mb-3 float mr-2 pr-5" target="_blank" ><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Export PDF</a>
               &nbsp;
                    <a href="{{route('export-revenues')}}" class="btn btn-success mb-3 float ml-2" target="_blank" ><i class="fa fa-export"></i>Export Excel</a>
               </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer" id="datatable_ajax" aria-describedby="datatable_ajax_info" role="grid">
                            <thead>
                                ...
                                <tr role="row" class="filter">
                                    ...
                                    <td rowspan="1" colspan="1" class="sr_no"></td>
                                    <td rowspan="1" colspan="1">
