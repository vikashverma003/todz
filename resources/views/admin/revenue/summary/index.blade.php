      ...
      <div class="col-lg-12 stretch-card">
         <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Revenues Summary</h4>
                    </div>
                ...
                <div class="table-responsive">
                    <form name="filter_listing">
                        <table class="table" aria-describedby="datatable_ajax_info" role="grid" id="datatable_ajax" >
                            <thead>
                ...
                <div class="table-responsive mt-4">
                    <table id="summary_datatable" class="table table-striped table-bordered table-hover dataTable no-footer" aria-describedby="datatable_ajax_info" role="grid" style="width:100%">
                        ...
                        <tbody id="dynamicContent">
                            @include('admin.revenue.summary.list')
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function cb(start, end) {
            ...
            loadListings(full_path + '/revenue-summary/?page=');
    ...
    const getRevenueGraphs = (start, end)=>{
        $.ajax({
            url:"{{url('admin/revenue-summary-graph')}}",
            type:'get',
            data:{
                'start':start,
                'end':end
            ...
            success:function(data){
                ...
                if(data.status)
                {
                    var label =[];
                    var value =[];
                    $.each(data.data.revenueResponse, function(key,val){
