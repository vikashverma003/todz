      ...
      <div class="col-lg-12 stretch-card">
         ...
         <div class="card">
            <div class="card-body">
               <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Terminated Project Wise Summary</h4>
                    </div>
                        ...
                        <div class="card" style="border: 1px solid">
                            <div class="card-body">
                                <a href="javascript:;" class="d-flex align-items-center justify-content-md-center" style="color:black;text-decoration:none">
                                    ...
                                    <div class="ml-3">
                                        <p class="mb-0">Total Projects Cost</p>
                ...
                <div class="table-responsive mt-0">
                    <table id="summary_datatable" class="table table-striped table-bordered table-hover dataTable no-footer" aria-describedby="datatable_ajax_info" role="grid" style="width:100%">
                        ...
                        <tbody id="dynamicContent">
                            @include('admin.reports.terminate-project-wise-summary.list')
                        </tbody>
                    </table>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function cb(start, end) {
            ...
            loadListings(full_path + '/terminated-project-wise-summary/?page=');
