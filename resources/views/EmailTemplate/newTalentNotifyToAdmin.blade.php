            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
              ...
              <tr>
                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" > 
                    ...
                    <p>New Talent register on portal with below informations:</p>
                    <p><strong>Name :</strong><span>{{$data->first_name}} {{$data->last_name}}</span></p>
                    <p><strong>Email :</strong><span>{{$data->email}}</span></p>
                    <p><strong>Phone :</strong><span>{{$data->phone_code}} {{$data->phone_number}}</span></p>
                    <p>Regards,</p>
