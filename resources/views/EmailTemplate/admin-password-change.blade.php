                    ...
                    <tr>
                        <td valign="top" style="vertical-align:top;border-collapse: collapse;">
                            ...
                            <table align="center" style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="background-color: #ffffff;" bgcolor="#ffffff">
                                        <img height="150" border="0" src="{{asset('web/images/forgot_password_graphic.png')}}" alt=""
                                            style="display: block;margin: auto;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size: 1px; line-height: 1px;" height="10"
                                ...
                                <tr>
                                    <td style="background-color: #ffffff;" bgcolor="#ffffff">
                                        <table class="deviceWidth1" width="530" style="margin: 0 auto; width: 530px;"
                                            ...
                                            <tr>
                                                <td>
                                                    <table style="width: 45%;margin: auto;">
                                                        <tr>
                                                            <td style="border-top: 3px solid #FED23D;">
                                                                &nbsp;</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <table style="margin: 0 auto;width: 480px;">
                                                        <tr>
                                                            ...
                                                            line-height: 23px;
                                                            text-align: center;">
                                                                You password changed successfully. Please login with new credentials.
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
